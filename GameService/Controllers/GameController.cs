...
public class GameController : ControllerBase
{
    ...
    public IActionResult Compute([FromBody] ComputeRequest request)
    {
        try
        {
            ...
            {
                Logger.Warn(
                    $"Invalid choices: PlayerChoice={request.PlayerChoice}, ComputerChoice={request.ComputerChoice}");
        ...
        {
            Logger.Error(ex,
                $"Error computing game result for PlayerChoice={request.PlayerChoice}, ComputerChoice={request.ComputerChoice}");
